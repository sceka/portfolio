...
function WorkLayout(_a) {
    var jobName = _a.jobName, inverse = _a.inverse, skills = _a.skills, description = _a.description, description1 = _a.description1, description2 = _a.description2;
    return (react_1["default"].createElement("div", { className: !inverse ? "work-layout-normal" : "work-layout-inverse" },
        react_1["default"].createElement("div", { className: 'work-details' },
            ...
            react_1["default"].createElement("div", { className: 'github-button-work-section' },
